    ...
    <div class="max-w-[1600px] mx-auto">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div class="glass-card rounded-xl p-8 flex flex-col justify-between items-center text-center relative z-10">
                ...
                <a href="index.php" class="bg-blue-600 w-full py-3 rounded-xl shadow-sm border border-blue-500 text-white font-black text-[10px] uppercase tracking-widest hover:bg-blue-700 transition-all group flex items-center justify-center gap-2 active:scale-95">
            ...
            <div class="px-6 py-4 bg-white/50 border-b border-gray-100 flex flex-wrap items-center gap-4">
                <form method="GET" class="flex flex-wrap items-center gap-3 w-full">
                    ...
                    <?php if (!empty($search) || !empty($filter_bu)): ?>
                        <a href="patch_insight.php" class="bg-rose-50 text-rose-600 px-4 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-rose-600 hover:text-white transition-all border border-rose-100 shadow-sm ml-2">
                            Clear Filters
                        </a>
                    <?php endif; ?>
                </form>
