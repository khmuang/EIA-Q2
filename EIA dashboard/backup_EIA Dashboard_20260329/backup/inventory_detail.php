...
<head>
    ...
    <style>
        ...
        .glass-card { 
            ...
            box-shadow: 0 10px 25px -5px rgba(30, 64, 175, 0.1), inset 0 0 10px rgba(255, 255, 255, 0.5);
        }
        
        /* Ultra Vibrant & Deep Shadows (150% Enhanced) */
        .hover-shadow-blue:hover { 
            box-shadow: 0 65px 135px -20px rgba(37, 99, 235, 0.95), 0 35px 75px -15px rgba(37, 99, 235, 0.75), 0 0 30px 4px rgba(37, 99, 235, 0.5); 
            border-color: rgba(37, 99, 235, 0.6);
            transform: translateY(-8px) scale(1.01);
        }
        .hover-shadow-indigo:hover { 
            box-shadow: 0 65px 135px -20px rgba(79, 70, 229, 0.95), 0 35px 75px -15px rgba(79, 70, 229, 0.75), 0 0 30px 4px rgba(79, 70, 229, 0.5); 
            border-color: rgba(79, 70, 229, 0.6);
            transform: translateY(-8px) scale(1.01);
        }
        .hover-shadow-emerald:hover { 
            box-shadow: 0 65px 135px -20px rgba(5, 150, 105, 0.95), 0 35px 75px -15px rgba(5, 150, 105, 0.75), 0 0 30px 4px rgba(5, 150, 105, 0.5); 
            border-color: rgba(5, 150, 105, 0.6);
            transform: translateY(-8px) scale(1.01);
        }
        .hover-shadow-slate:hover { 
            box-shadow: 0 65px 135px -20px rgba(30, 41, 59, 0.8), 0 35px 75px -15px rgba(30, 41, 59, 0.6), 0 0 30px 4px rgba(30, 41, 59, 0.4); 
            border-color: rgba(30, 41, 59, 0.5);
            transform: translateY(-8px) scale(1.01);
        }
        .hover-shadow-orange:hover { 
            box-shadow: 0 65px 135px -20px rgba(234, 88, 12, 0.95), 0 35px 75px -15px rgba(234, 88, 12, 0.75), 0 0 30px 4px rgba(234, 88, 12, 0.5); 
    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="bg-white/90 backdrop-blur-xl rounded-xl p-5 md:p-8 shadow-2xl shadow-blue-900/10 border border-white mb-8 flex flex-col xl:flex-row justify-between items-center gap-8 relative overflow-hidden">
            ...
            <div class="flex-1 w-full relative z-10">
                ...
                <p class="text-[11px] md:text-sm font-bold text-slate-500 flex items-center gap-2">Serial No: <span class="bg-slate-100/80 text-slate-600 px-2.5 py-0.5 rounded-lg border border-slate-200 text-[10px] md:text-xs font-black tracking-widest"><?= htmlspecialchars($device['serial_no']) ?></span></p>
                ...
                <div class="mt-6 p-5 bg-slate-50/80 dark:bg-slate-900/30 rounded-2xl border border-slate-200/50 shadow-inner max-w-4xl">
                    <div class="flex items-center gap-2 mb-3 border-b border-slate-200/50 pb-2">
                        <span class="text-[10px] font-black text-blue-600 uppercase tracking-[0.2em]">Quick Compliance Insight</span>
                    </div>
                    <?php 
                    ...
                    ?>
                    <p class="text-[12px] md:text-[13px] leading-loose text-slate-600 dark:text-slate-300 font-bold">
            ...
            <div class="w-full xl:w-auto flex flex-col md:flex-row xl:flex-col gap-4 items-center xl:items-end relative z-10">
                <div class="flex gap-2 w-full justify-center md:justify-start xl:justify-end">
                    ...
                    <a href="<?= htmlspecialchars($back_url) ?>" class="bg-white/80 backdrop-blur-sm px-4 py-2 rounded-xl shadow-md border border-slate-200 text-slate-500 font-bold flex items-center gap-2 hover:text-blue-600 hover:border-blue-300 transition-all group text-[10px] uppercase tracking-widest">
                ...
                <div class="bg-slate-50/80 p-4 md:px-8 md:py-4 rounded-[1.5rem] border border-slate-100 text-center min-w-[200px] shadow-inner relative overflow-hidden backdrop-blur-sm flex flex-col items-center">
                    <p class="text-[9px] font-black text-slate-400 uppercase tracking-[0.2em] mb-1 relative z-10">Compliance Score</p>
                    <?php 
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="glass-card relative rounded-xl p-8 shadow-xl hover-shadow-slate transition-all duration-300 group bg-slate-50/50">
                ...
                <div>
                    ...
                    <div class="bg-white p-4 rounded-2xl border border-slate-100 text-[13px] font-mono text-slate-700 max-h-32 overflow-y-auto shadow-inner leading-relaxed">
