...
if (!$data_from_cache) {
    ...
    try {
        ...
        // Save to Cache
        $cache_payload = compact('current_total','g_full','g_minor','g_at_risk','g_critical','p_full','p_minor','p_at_risk','p_critical','s1','s2','s3','topic_results','total_success_sum','overall_rate','serviced_data','bu_data','max_bu_val','week','year','last_updated');
    ...
    <div class="max-w-7xl mx-auto bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center p-5 border-b border-gray-100 gap-4 md:gap-0">
            ...
            <div class="flex flex-wrap items-center gap-3 text-sm w-full md:w-auto">
                ...
                <a href="https://centralgroup.sharepoint.com/sites/ITS/SitePages/ProjectHome.aspx" target="_blank" class="bg-white px-4 py-2 rounded-lg border hover:bg-blue-50 hover:border-blue-200 text-blue-600 transition-colors flex items-center gap-2 font-bold text-xs uppercase shadow-sm">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
                    SharePoint
                </a>
                <a href="logout.php" class="bg-rose-50 px-4 py-2 rounded-lg border border-rose-100 hover:bg-rose-100 text-rose-600 transition-colors flex items-center gap-2 font-bold text-xs uppercase ml-1 shadow-sm" title="Logout">
