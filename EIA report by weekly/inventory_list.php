...
$bu_options = getDistinctBUs($pdo);
$team_options = getDistinctTeams($pdo);
...
$items = getInventoryList($pdo, $limit, $offset, $where_sql, $params);

// Total for Pagination
$total_rows = getInventoryTotalCount($pdo, $where_sql, $params);
$total_pages = ceil($total_rows / $limit);

// --- 4. Export Logic (Full 35 Fields) ---
if (isset($_GET['export']) && $_GET['export'] == 'excel') {
    $all_items = getInventoryForExport($pdo, $where_sql, $params);
