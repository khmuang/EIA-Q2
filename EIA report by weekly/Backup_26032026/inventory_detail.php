    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="glass-card rounded-[2.5rem] p-8 shadow-xl hover:-translate-y-2 hover:shadow-2xl hover:shadow-orange-500/20 transition-all duration-300 group">
                ...
                <div class='flex justify-between items-center py-3 border-t border-slate-50'>
                    <span class='text-[11px] font-bold text-slate-400 uppercase tracking-wider'>GLPI Agent Status</span>
                    <span class='text-xs font-black text-slate-700 bg-slate-100 px-3 py-1 rounded-full'><?= htmlspecialchars($device['glpi_agent_status'] ?? 'N/A') ?></span>
                </div>
            </div>
